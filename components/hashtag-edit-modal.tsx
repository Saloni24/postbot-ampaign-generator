...
export function HashtagEditModal({ isOpen, onClose, hashtags, onSave }: HashtagEditModalProps) {
  ...
  const handleSave = () => {
    onSave(editedHashtags)
    onClose()
  }

  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
      <div className="bg-white rounded-xl shadow-[8px_8px_16px_#d1d9e6,-8px_-8px_16px_#ffffff] w-full max-w-md overflow-hidden">
        <div className="p-6 border-b border-[#E2E8F0] flex justify-between items-center">
          <h2 className="text-xl font-semibold text-[#0F172A]">Edit Hashtags</h2>
